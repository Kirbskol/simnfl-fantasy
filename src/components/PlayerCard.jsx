...
const PlayerCard = (props) => {
    ...
    return (
        <div className={`player-card p-4 border-2 border-gray-300 rounded-lg shadow-md flex flex-col items-center ${OVR >= 80 ? 'bg-shiny-gold text-white' : 'bg-shiny-dark-blue text-white'} flex-grow`} style={{ width: 'calc(33.333% - 10px)', margin: '5px' }} onClick={() => handlePlayerSelect(ID)}>
